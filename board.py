...
def create_playerturn(root, txt):
	tag="dpbox"
	root.delete(tag)
	canvas_id = root.create_text(S_WIDTH*AREA*0.5, S_HEIGHT*AREA+ S_HEIGHT*1.5, tag="dpbox", font=("Comic Sans MS", 12, "bold"), anchor="center")
	root.itemconfig(canvas_id, text=txt)

def player_color(root, txt):
	tag="pcolor"
	root.create_text(S_WIDTH*AREA*0.5, S_HEIGHT*AREA+ S_HEIGHT*0.8, tag="pcolor", font=("Comic Sans MS", 10, "bold"), anchor="center", text=txt)
